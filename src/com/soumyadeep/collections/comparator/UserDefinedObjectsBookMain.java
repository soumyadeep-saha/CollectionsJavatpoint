...
public class UserDefinedObjectsBookMain {
	...
	public static void main(String[] args) {
		...
		Iterator<UserDefinedObjectsBook> itr1=arrayList.iterator();
		while(itr1.hasNext()) {
			UserDefinedObjectsBook ub=(UserDefinedObjectsBook)itr1.next();
			System.out.println(ub.id);
			System.out.println(ub.name +" "+ub.author+" "+ub.publisher+" "+ub.quantity);
		}
		
		System.out.println("<<<<name comparator>>>>");
		Collections.sort(arrayList,new NameComparator());
		Iterator<UserDefinedObjectsBook> itr2=arrayList.iterator();
		while(itr2.hasNext()) {
			UserDefinedObjectsBook ub=(UserDefinedObjectsBook)itr2.next();
			System.out.println(ub.id);
			System.out.println(ub.name +" "+ub.author+" "+ub.publisher+" "+ub.quantity);
		}
	}
